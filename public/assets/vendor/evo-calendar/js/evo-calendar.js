...
;(function(factory) {
    ...
    EvoCalendar = (function() {
        ...
        function EvoCalendar(element, settings) {
            ...
            _.initials = {
                ...
                dates: {
                    ...
                    id: {
                        ...
                        noEventForToday: "Tidak ada acara untuk hari ini !",
            ...
            _.moveMonth = $.proxy(_.moveMonth, _);
    ...
    EvoCalendar.prototype.initEventListener = function() {
        ...
        // set event listener for prev next month
        _.$elements.calendarEl.find('[data-month-move]')
        .off('click.evocalendar')
        .on('click.evocalendar', _.moveMonth);
        ...
        if (!_.$elements.calendarEl.html()) {
            ...
            markup += '<div class="calendar-inner">'+
                            '<table class="calendar-table">'+
                                '<tr> <th style=\"text-align:center\" > <a href=\"#/\" class="prev-month" data-month-move=\"prev\" style=\"text-decoration:none;color: #5a5a5a\"> <i class="fa fa-chevron-left"></i> </a> </th>  <th style=\"text-align:center\" colspan="5" id="month-title"></th> <th style=\"text-align:center\"> <a href=\"#/\" style=\"text-decoration:none;color: #5a5a5a;\" data-month-move=\"next\" class=\"next-month\"> <i class="fa fa-chevron-right"></i> </a> </th> </tr>'+
                                '<tr colspan=\"7\" rowspan=\"3\"><th>&nbsp</th><th>&nbsp</th><th>&nbsp</th></tr>'+
    ...
    EvoCalendar.prototype.buildCalendar = function() {
        ...
        _.$elements.innerEl.find('.calendar-table #month-title').text(title);
    ...
    ****************/
    ...
    EvoCalendar.prototype.moveMonth = function(event) {
        var _ = this;
        var el = $(event.target).closest('[data-month-move]');
        let monthVal = $(el).data('monthMove');
        if(monthVal == "prev") {
            if(_.$active.month==0){
                _.$active.month = 11;
                --_.$active.year;
        ...
        // EVENT FIRED: selectMonth
        $(_.$elements.calendarEl).trigger("moveMonth", [_.initials.dates[_.options.language].months[_.$active.month], _.$active.month]);
    ...
    EvoCalendar.prototype.selectToday = function() {
        var _ = this;
        var todayDate = _.$current.date;
        var date, year, month, activeDayEl, isSameDate;
        date = _.formatDate(new Date(todayDate), _.options.format);
        year = new Date(date).getFullYear();
        month = new Date(date).getMonth();
        _.selectYear(year);
        _.selectMonth(month);
        ...
        // EVENT FIRED: selectDate
        $(_.$elements.calendarEl).trigger("selectDate", [_.$active.date])
    }
