...
<div class="modal" id="modal_add_regency" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
    <div class="modal-dialog">
        <form action="<?php echo site_url('Regency/addRegency'); ?>" method="post">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Add Kota/Kabupaten</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group">
                            <label class="control-label col-xs-3" >Kota/Kabupaten</label>
                            <div class="col-xs-8">
                                <input name="regency_name" class="form-control" type="text" value="" required>
                            </div>
                        </div><br><br>
                        <div class="form-group">
                            <label class="control-label col-xs-3" >Provinsi</label>
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-3" >Jumlah Penduduk</label>
                            <div class="col-xs-8">
                                <input name="total_population" class="form-control" type="text" value="" required>
                            </div>
                        </div>
                    </div><br>
                </div>
